...
VARIANTS: List[Variant] = [
    Variant(
        ...
        ROOT / '_posts/ru/2019-08-08-text-and-typography.md',
        'en',
        'ru',
        'ru-RU',
    ),
    Variant(
        ROOT / '_posts/2019-08-08-text-and-typography.md',
        ROOT / '_posts/fr/2019-08-08-text-and-typography.md',
        'en',
        'fr',
        'fr-FR',
    ),
    Variant(
        ...
        ROOT / '_posts/ru/2019-08-08-write-a-new-post.md',
        'en',
        'ru',
        'ru-RU',
    ),
    Variant(
        ROOT / '_posts/2019-08-08-write-a-new-post.md',
        ROOT / '_posts/fr/2019-08-08-write-a-new-post.md',
        'en',
        'fr',
        'fr-FR',
    ),
    Variant(
        ...
        ROOT / '_posts/ru/2019-08-09-getting-started.md',
        'en',
        'ru',
        'ru-RU',
    ),
    Variant(
        ROOT / '_posts/2019-08-09-getting-started.md',
        ROOT / '_posts/fr/2019-08-09-getting-started.md',
        'en',
        'fr',
        'fr-FR',
    ),
    Variant(
        ...
        ROOT / '_posts/ru/2019-08-11-customize-the-favicon.md',
        'en',
        'ru',
        'ru-RU',
    ),
    Variant(
        ROOT / '_posts/2019-08-11-customize-the-favicon.md',
        ROOT / '_posts/fr/2019-08-11-customize-the-favicon.md',
        'en',
        'fr',
        'fr-FR',
    ),
    Variant(
        ...
        ROOT / '_posts/ru/2026-02-17-nlo-vs-chirpy-diff-log.md',
        'en',
        'ru',
        'ru-RU',
    ),
    Variant(
        ROOT / '_posts/2026-02-17-nlo-vs-chirpy-diff-log.md',
        ROOT / '_posts/fr/2026-02-17-nlo-vs-chirpy-diff-log.md',
        'en',
        'fr',
        'fr-FR',
    ),
